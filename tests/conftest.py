...
def driver(request):
    ...
    if config.host == 'saucelabs':
        test_name = request.node.name  # adicionar o nome do teste baseado no
        capabilities = {
    ...
    def quit():  # sub-função para finalizar o objeto do Selenium
        ...
        # executar um  no SauceLabs que sinaliza para o nosso terminal o resultado baseado na regra
